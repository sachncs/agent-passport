...
JavaScript / TypeScript SDK for the [Agent Passport](https://github.com/anomalyco/agent-passport) service. Provides strongly-typed access to trust scoring, delegation, credit, sybil, reputation, underwriting, graph analytics, and passport generation for Algorand wallets.
