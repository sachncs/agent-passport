...
(chat rooms, mailing lists, social media) where an individual is representing the
project. It also applies when an individual is representing the project in
public spaces (events, conferences, online forums).
